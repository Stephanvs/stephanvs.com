...
<blockquote>
  ...
  <footer>&mdash; A smart person.</footer>
</blockquote>
...
Lets just start of by saying, there are soo many options, I can't do it any justice
in including just a single paragraph in this blog entry. One could probably write
an entire book on just switches alone. Things like linear/tactile, loudness, 'clickyness',
feedback, travel are just the tip of the iceberg I had to learn when getting into
this scene.
...
![Sakurio 62g Silent Linear Switches](./sakurios.webp)
...
- [GeekHack](https://geekhack.org/index.php?board=31.0)
- [reddit.com/olkb](https://www.reddit.com/r/olkb/)
- [reddit.com/MechanicalKeyboards](https://www.reddit.com/r/MechanicalKeyboards/)
